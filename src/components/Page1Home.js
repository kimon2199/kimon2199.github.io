...
const HomePage = () => {
  ...
  const characteristics = ["Software Engineer", "Back-End Developer"];
    ...
    <div className="flex justify-center items-center h-full w-full">
      <div className="grid sm:grid-cols-2 w-full gap-4 h-full text-xl sm:text-3xl flex items-center">
        <div className="">
          ...
          <h1 className="p-5 font-bold block text-white mono">
            {`Hi I'm Kimon and I'm a `}
          ...
          <div className="flex justify-center sm:justify-start ml-5">
            <button
              onClick={() =>
                openInNewTab("https://www.linkedin.com/in/kimon-softas/")
              }
              className="m-3 relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-200 rounded-lg group bg-gradient-to-br hover:from-violet-700 hover:to-emerald-400 hover:text-white dark:text-white ring-2 ring-gray-200"
            >
              <span className="flex relative px-5 py-2.5 transition-all ease-in duration-75 dark:bg-gray-900 rounded-md ">
                <svg
            ...
            <button
              onClick={() => openInNewTab("https://github.com/kimon2199")}
              className="m-3 relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-200 rounded-lg group bg-gradient-to-br hover:from-violet-700 hover:to-emerald-400 hover:text-white dark:text-white ring-2 ring-gray-200"
            >
              <span className="flex relative px-5 py-2.5 transition-all ease-in duration-75 dark:bg-gray-900 rounded-md ">
                <svg
